 ...
 * <p>
 * Cette classe gère l'interface graphique (Swing), les interactions utilisateur
 * et la communication avec le contrôleur et le modèle.
 * </p>
 */
public class FenetreGlobale extends JFrame implements ActionListener {
    ...
    /** Indique si le mode deux joueurs est actif */
    ...
    /** États du contrôleur (pattern State) */
     ...
     *
     * @param controlleurJeu contrôleur principal
     * @param etatCreationCercle état de création de cercle
     * @param etatCreationRectangle état de création de rectangle
     * @param jeu modèle du jeu
     */
    public FenetreGlobale(VueControlleurJeu controlleurJeu,
                         VueControlleurState etatCreationCercle,
                         VueControlleurState etatCreationRectangle,
                         JeuFormes jeu) {
        ...
        this.vueJeu2D = new VueJeu2D(
                (EtatCreationCercle) etatCreationCercle,
        ...
        /**
         * Initialise les dimensions réelles de la zone de dessin
         * et démarre la première partie.
         */
        javax.swing.SwingUtilities.invokeLater(() -> {
            ...
            ((ScoreParSurface) jeu.getCalculScore())
                    .setSurfaceTotale(largeur * hauteur);
    ...
    /**
     * Gère les actions des boutons de l'interface.
     *
     * @param ae événement utilisateur
     */
    @Override
        ...
        if (ae.getSource() == bouttonValider) {
            ...
            if (modeDeuxJoueursActif
                ...
                JOptionPane.showMessageDialog(this,
                        "Joueur 2 : place tes formes BLEUES pour marquer des points !");
            } else {
                ...
                if (fin) {
                    ...
                    for (int i = 0; i < scores.size(); i++) {
                        recap.append("Partie ").append(i + 1)
                                ...
                                .append(" - ")
                                .append(String.format("%.1f", pourcentages.get(i)))
                                .append("%\n");
                    }

                    double moyenne = pourcentages.stream()
                            .mapToDouble(d -> d)
                            .average()
                            .orElse(0);

                    recap.append("\nScore global : ")
                            .append(String.format("%.1f", moyenne))
                            .append("%");

                    JOptionPane.showMessageDialog(this, recap.toString(),
                            "Résultats finaux", JOptionPane.INFORMATION_MESSAGE);

                    labelScore.setText("Score global : "
